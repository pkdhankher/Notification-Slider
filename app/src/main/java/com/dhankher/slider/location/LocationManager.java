...
public class LocationManager implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private final LocationUpdateDetector locationUpdateDetector;
    ...
    public LocationManager(Context context, LocationUpdateDetector locationUpdateDetector) {
    ...
    public Loc getLastKnownLocation() {
        return location;
    }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        try {
            ...
            builder.append(" ");
            String currentCity = builder.toString(); //This is the city name.
